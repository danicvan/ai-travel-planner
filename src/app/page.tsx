...
export default function HomePage() {
    ...
    <Header />
    <section className="flex flex-col items-center mt-6 p-4 w-full max-w-5xl mx-auto">
        <div className="flex flex-row justify-between items-center w-full">
            <h1 className="text-xl font-medium text-gray-900">Trello AI</h1>
            <GreetingMessage
        ...
        <DragDropContext onDragEnd={handleDragEnd}>
            <div className="flex flex-row justify-between w-full gap-4 mt-6">
                {columns.map((column) => (
                    <Droppable key={column.id} droppableId={column.id}>
                        {(provided) => (
                            <div
                                ...
                                className="w-1/3 bg-gray-100 rounded p-4"
                            >
                                        ...
                                        >
                                            {(provided) => (
                                                <li
                                                    ...
                                                    className="p-2 bg-white rounded border border-gray-200 cursor-grab"
                                ...
                                <button
                                    className="mt-4 bg-gray-100 text-gray-500 text-sm rounded p-2 hover:bg-gray-200 hover:text-gray-700"
