            ...
            <div className="w-full max-w-lg rounded-xl bg-white shadow-lg p-6">
                ...
                <div className="mt-4">
                    <textarea
                        ...
                        id="columnTile"
                        name="columnTitle"
                        className="resine-none mt-2 block w-full rounded-lg border border-gray-300 bg-gray-50 py-1.5 px-3 text-sm text-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    >
                    </textarea>
                </div>
